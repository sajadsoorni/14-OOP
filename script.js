...
Person.hey();
// jonas.hey(); // we cannot say Jonas.hey because it is simply not in the prototype of the Jonas object.
...
3. Implement an 'accelerate' method that will increase the car's speed by 20, and decrease the charge by 1%. Then
 log a message like this: 'Tesla going at 140 km/h, with a charge of 22%';
